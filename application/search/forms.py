...
class SearchForm(BaseForm):
    ...
    genres = MultiCheckboxField("Genret", coerce=int)
    tags = MultiCheckboxField("Omat tägit", coerce=int)
    ...
    min_reviews = IntegerField("Arvostelujen lukumäärä(min)", [validators.Optional])
    max_reviews = IntegerField("Arvostelujen lukumäärä(max)", [validators.Optional])
